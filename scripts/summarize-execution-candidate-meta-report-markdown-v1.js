...
const healthAlignment = parseHealthAlignment();

console.log('## Execution Candidate Meta Report');
console.log();
...
console.log('| --- | --- |');
console.log(`| present | ${tooling.present} |`);
console.log(`| missing | ${tooling.missing} |`);
console.log();
console.log('| validator suite status | value |');
console.log('| --- | --- |');
console.log(`| overall | ${validatorSummary.overall} |`);
console.log(`| total validators | ${validatorSummary.total_validators} |`);
console.log(`| passed | ${validatorSummary.passed} |`);
console.log(`| failed | ${validatorSummary.failed} |`);
console.log();
console.log('| health alignment | value |');
console.log('| --- | --- |');
console.log(`| overall alignment | ${healthAlignment} |`);
