...
function buildActionPlan(task, gptPlanText) {
  const lines = [
    ...
    "2. Execute only the immediate execution slice from the GPT plan, not the whole subsystem.",
    ...
    "",
    "Verification:",
    "- Confirm the intended files or outcome for the immediate execution slice exist.",
