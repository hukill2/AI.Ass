// Usage: node scripts/run-local-assistant-deepseek-v1.js
const fs = require('fs');
...
const OUTPUT_PATH = path.join(ROOT, 'runtime', 'local-assistant-response.deepseek.v1.txt');
...
const cmd = spawnSync('ollama', ['run', 'deepseek-coder:6.7b'], {
  cwd: ROOT,
  encoding: 'utf8',
  input: prompt,
  timeout: 120 * 1000,
...
console.log('Model used: deepseek-coder:6.7b');
