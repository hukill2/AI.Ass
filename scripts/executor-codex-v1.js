    ...
    messages: [
      {
        ...
        content: [
          ...
          "Optimize plans for a brittle local executor that succeeds best on very small bounded slices.",
          "For implementation tasks, choose one immediate execution slice only, ideally 1-3 files or one coherent repair unit.",
          "Push all additional work into a short deferred follow-ups section instead of stuffing the whole subsystem into the immediate slice.",
          "Do not include long sample code blocks unless absolutely necessary for a blocker.",
          "Prefer explicit target files, explicit verification commands, and the narrowest possible next step.",
...
function buildFallbackPlan(task, promptPackageText) {
  return [
    ...
    "2. Define one immediate execution slice only, ideally 1-3 files or one coherent repair unit.",
    "3. Defer additional work into a short follow-up list instead of broadening the current execution.",
    "4. Preserve the existing Notion -> mirror -> review -> execution pipeline.",
    "5. Include a narrow verification step before claiming completion.",
    "",
