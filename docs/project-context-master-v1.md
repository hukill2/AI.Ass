...
- **Completed lanes:** assistant decisions → reviews → execution candidates → executor payloads → executor handoff/preview → qwen-readonly → qwen-write dry run → qwen-write real execution → post-write verification logging and reporting.
...
- **Optional cleanup:** rename legacy `executor-*` artifacts, shrink this index further if desired, expand verification rules beyond JS syntax checks when needed.
...
- [`docs/executor-handoff-dry-run-contract-v1.md`](docs/executor-handoff-dry-run-contract-v1.md) – executor packet shape and preparation helper.
- [`docs/executor-invocation-preview-contract-v1.md`](docs/executor-invocation-preview-contract-v1.md) – preview payload shape and derivation.
- [`docs/executor-real-executor-readonly-plan-v1.md`](docs/executor-real-executor-readonly-plan-v1.md) – real executor guardrails and logging.
...
- [`docs/executor-execution-contract-v1.md`](docs/executor-execution-contract-v1.md) – future work/Conceptual executor executor; not required for v1 closeout.
